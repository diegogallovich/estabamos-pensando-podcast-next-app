        ...
        <div className="flex flex-col items-start">
          ...
          <div className="mt-4 flex items-center gap-4">
            <button
              ...
              className="flex items-center text-sm font-bold leading-6 text-red-500 hover:text-red-700 active:text-red-500"
...
export default function Home({ episodes }) {
  ...
  return (
    <>
      <Head>
        <title>Estabamos Pensando - Conversaciones Digitales.</title>
        <meta
          name="description"
